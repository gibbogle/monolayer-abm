...
clonohypoxic_percent_10 = 10*clonohypoxic_percent
...
write(nfres,'(a,a,2a12,i8,e12.4,22i7,39e12.4,i6)') trim(header),' ',gui_run_version, dll_run_version, &
...
write(nflog,'(a,f12.0)') 'Ncells: ',summaryData(2)
